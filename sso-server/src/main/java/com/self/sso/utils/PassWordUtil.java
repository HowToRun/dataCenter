...
public class PassWordUtil {
    ...
    public static String getSaltMD5(String password) {
        ...
        password = md5Hex(passwordAndSalt);
        char[] cs = new char[48];
    ...
    public static void main(String[] args) {
        ...
        // 获取加盐后的MD5值
        String ciphertext = PassWordUtil.getSaltMD5(plaintext);
        System.out.println("加盐后MD5：" + ciphertext);
        System.out.println("是否是同一字符串:" + PassWordUtil.getSaltverifyMD5(plaintext, ciphertext));
    }
